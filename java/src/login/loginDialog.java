...
public class loginDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public loginDialog(String[] loginRoles) {
		...
		{
			comboBox1 = new JComboBox<String>(loginRoles);
	...
	private void onOK() {
		...
		role = (String) comboBox1.getSelectedItem();
		dispose();
	}
	...
	static public String[] loginDialogOpen(String title, String[] loginRolesList) {
		String[] myReturnString;
		loginDialog dialog = new loginDialog(loginRolesList);
		dialog.pack();
